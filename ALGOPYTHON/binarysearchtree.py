...
class BST(object):
    ...
    def _get(self, node_x, key):
        ...
        if key == node_x.key:
            ...
            return self._get(node_x.left, key)
        else:
            return self._get(node_x.right, key)
    ...
    def _select(self, node_x, rank_k):
        ...
        if sz_left == rank_k:
            ...
            return self._select(node_x.right, rank_k - sz_left - 1)
        else:
            return self._select(node_x.left, rank_k)
    ...
    def _rank(self, key, node_x):
        ...
        if key == node_x.key:
            ...
            return self._rank(key, node_x.left)
        else:
            return 1 + self._size(node_x.left) + self._rank(key, node_x.right)
    ...
    def nodes(self):
        return self._nodes_lohi(self.get_min(), self.get_max())
    ...
    def isBST(self):
        return self._isBST(self._root, minval=None, maxval=None)
    ...
    def isSizeConsistent(self):
        return self._isSizeConsistent(self._root)
